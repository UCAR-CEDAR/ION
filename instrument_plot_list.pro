pro instrument_plot_list, verbosity

query='SELECT DISTINCT concat(tbl_instrument.INST_NAME,"%",tbl_instrument.PREFIX,"%",tbl_instrument.KINST) FROM tbl_instrument,tbl_plotting_params WHERE tbl_instrument.KINST=tbl_plotting_params.KINST ORDER BY tbl_instrument.KINST ASC;'
